public class B4_MiltonFilter extends World
{
   ...
   public void go()
   {
      plane.loadBackGround("tweety.png");          //*** new method to load a diffrent JPG
      System.out.println("This will be printed to the  window. ");
      plane.teleport(0,0);
      plane.showBackGround();                    
      System.out.println(plane.howMuchRed());         
   
      for(int row=0; row<330; row++)    //*** this is using new getBackground
      {
         for(int col=0; col<200; col++)    //*** this is using new getBackgroun
         {
        ...
        //       plane.setPixelColor(39,115,229);
         //   }
            if((red>250 && green>170 && blue>50) && (red<255 && green<255 && blue<255))
            {
